...
require_once '../aop/request/AlipayFundAuthOrderFreezeRequest.php';

// 初始化SDK
$alipayClient = new AopClient(getAlipayConfig());
// 构造请求参数以调用接口
$request = new AlipayFundAuthOrderFreezeRequest();
$model = array();
...
// 设置用户付款码
$model['auth_code'] = "付款码场景：28763443825664394，刷脸场景：fp1394da8bfc3e299a2128b8bda17456h84";
