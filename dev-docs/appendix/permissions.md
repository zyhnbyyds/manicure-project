...
| `biz:refund:approve`      | 退款审批-approve   | 退款审批   | 按钮 | 服务中发起退款 / 重试执行 / 驳回（**只给店长**）                                     |
...
| `biz:refund:apply`                     | `POST /api/v1/biz/refunds`（**仅服务开始前**）、`POST /api/v1/biz/refunds/preview`、`POST /api/v1/biz/bookings/:id/refund`、`GET /api/v1/biz/bookings/:id/refund-preview`                                                                                                                              | `biz/payment/refunds/` + `biz/booking/`                                                                     |
| `biz:refund:list`                      | `GET /api/v1/biz/refunds`                                                                                                                                                                                                                                                                              | `biz/payment/refunds/`                                                                                      |
| `biz:refund:approve`                   | `POST /api/v1/biz/refunds`（**服务中退款**）、`POST /api/v1/biz/refunds/:id/approve`（重试）、`POST /api/v1/biz/refunds/:id/reject`                                                                                                                                                                    | 同上                                                                                                        |
