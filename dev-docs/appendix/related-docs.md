...
| `cashier-payment`               | 收银与支付：微信 Native 扫码 / 支付宝当面付、线下收款记账、定金与尾款、混合支付、回调验签与幂等、主动查单与关单、退款判责与申请审批分离、渠道对账差异（§4.5 / §5.8 / §7.4 / §9.8 / §17 / §12 B3）                                                                          | 实现或修改 `/biz/payments`、`/biz/refunds`、`/biz/payment-diffs`、收银台；处理回调、尾款补收、退款审批、对账差异                                                    |
